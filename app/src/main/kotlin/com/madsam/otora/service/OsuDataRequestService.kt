...
class OsuDataRequestService {
    ...
    */
    private val moshi = Moshi.Builder()
        ...
        .add(SafeCountryAdapter())
        .add(SafeCountryExtendAdapter())
        .add(SafeRankHighestAdapter())
        .add(SafeHypeAdapter())
        .add(SafeRankHistoryAdapter())
        .add(SafeTournamentBannerListAdapter())
        .add(SafeBadgeListAdapter())
        .add(SafeVariantListAdapter())
        .add(SafeAchievementListAdapter())
        .add(SafeRecentActivityListAdapter())
