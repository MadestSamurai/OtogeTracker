...
internal data class ChuniJpDTO(
    @param:Json(name = "songs") var songs: List<ChuniSong> = listOf(),
    ...
    internal data class ChuniSong (
        @param:Json(name = "songId") var songId: String = "",
        @param:Json(name = "category") var category: String = "",
        ...
        @param:Json(name = "comment") var comment: String = "",
        @param:Json(name = "sheets") var sheets: List<ChuniSongSheet> = listOf()
    ) {
        internal data class ChuniSongSheet(
            @param:Json(name = "type") var type: String = "",
            @param:Json(name = "difficulty") var difficulty: String = "",
            @param:Json(name = "level") var level: String = "",
            @param:Json(name = "levelValue") var levelValue: Double = 0.0,
            @param:Json(name = "internalLevel") var internalLevel: String = "",
            @param:Json(name = "internalLevelValue") var internalLevelValue: Double = 0.0,
