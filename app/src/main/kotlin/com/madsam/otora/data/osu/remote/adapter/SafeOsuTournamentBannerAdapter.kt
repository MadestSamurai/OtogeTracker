...
internal class SafeOsuTournamentBannerAdapter {
    ...
    @FromJson
    fun fromJson(reader: JsonReader): OsuUserExtendDTO.ActiveTournamentBanner {
        return if (reader.peek() == JsonReader.Token.NULL) {
            reader.nextNull<OsuUserExtendDTO.ActiveTournamentBanner>()
            OsuUserExtendDTO.ActiveTournamentBanner()
        } else {
            activeTournamentBannerAdapter.fromJson(reader) ?: OsuUserExtendDTO.ActiveTournamentBanner()
        }
    }
}