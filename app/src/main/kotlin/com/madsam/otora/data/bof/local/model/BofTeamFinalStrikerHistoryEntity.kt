...
/**
 * BOF团队决胜作品历史记录Entity
 * 存储团队决胜作品（Final Striker）的变更历史
 * 使用 workSlot 字段区分不同的作品位置（1-4）
 */
@Entity
internal data class BofTeamFinalStrikerHistoryEntity(
    @Id var id: Long = 0,
    ...
    var finalStriker: String = "" // 决胜作品标识
) {
    companion object {
        /**
         * 解析时间字符串为时间戳
        ...
        fun parseTimestamp(timeString: String): Long {
            return try {
                ...
                Log.e("BofTeamFinalStrikerHistoryEntity", "Failed to parse timestamp: $timeString", e)
                0L
            }
        }
    }
