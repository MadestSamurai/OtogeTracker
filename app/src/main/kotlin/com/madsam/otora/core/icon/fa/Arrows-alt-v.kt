...
public val Fa.`Arrows-alt-v`: ImageVector
    get() {
        if (`_arrows-alt-v` != null) {
            return `_arrows-alt-v`!!
        }
        `_arrows-alt-v` = Builder(name = "Arrows-alt-v", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_arrows-alt-v`: ImageVector? = null
