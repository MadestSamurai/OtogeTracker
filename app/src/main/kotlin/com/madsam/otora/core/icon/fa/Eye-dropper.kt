...
public val Fa.`Eye-dropper`: ImageVector
    get() {
        if (`_eye-dropper` != null) {
            return `_eye-dropper`!!
        }
        `_eye-dropper` = Builder(name = "Eye-dropper", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_eye-dropper`: ImageVector? = null
