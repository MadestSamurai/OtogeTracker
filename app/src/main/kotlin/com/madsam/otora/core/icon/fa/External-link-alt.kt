...
public val Fa.`External-link-alt`: ImageVector
    get() {
        if (`_external-link-alt` != null) {
            return `_external-link-alt`!!
        }
        `_external-link-alt` = Builder(name = "External-link-alt", defaultWidth = 640.0.dp,
...
private var `_external-link-alt`: ImageVector? = null
