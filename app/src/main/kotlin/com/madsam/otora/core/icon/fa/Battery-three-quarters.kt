...
public val Fa.`Battery-three-quarters`: ImageVector
    get() {
        if (`_battery-three-quarters` != null) {
            return `_battery-three-quarters`!!
        }
        `_battery-three-quarters` = Builder(name = "Battery-three-quarters", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(405.3f, 400.0f, 416.0f, 389.3f, 416.0f, 376.0f)
                lineTo(416.0f, 264.0f)
...
private var `_battery-three-quarters`: ImageVector? = null
