...
public val Fa.`Check-to-slot`: ImageVector
    get() {
        if (`_check-to-slot` != null) {
            return `_check-to-slot`!!
        }
        `_check-to-slot` = Builder(name = "Check-to-slot", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_check-to-slot`: ImageVector? = null
