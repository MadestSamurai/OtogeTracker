...
public val Fa.`List-squares`: ImageVector
    get() {
        if (`_list-squares` != null) {
            return `_list-squares`!!
        }
        `_list-squares` = Builder(name = "List-squares", defaultWidth = 640.0.dp, defaultHeight =
                640.0.dp, viewportWidth = 640.0f, viewportHeight = 640.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(104.0f, 112.0f)
                curveTo(90.7f, 112.0f, 80.0f, 122.7f, 80.0f, 136.0f)
                lineTo(80.0f, 184.0f)
                curveTo(80.0f, 197.3f, 90.7f, 208.0f, 104.0f, 208.0f)
                lineTo(152.0f, 208.0f)
                curveTo(165.3f, 208.0f, 176.0f, 197.3f, 176.0f, 184.0f)
                lineTo(176.0f, 136.0f)
                curveTo(176.0f, 122.7f, 165.3f, 112.0f, 152.0f, 112.0f)
                ...
                moveTo(80.0f, 296.0f)
                lineTo(80.0f, 344.0f)
                curveTo(80.0f, 357.3f, 90.7f, 368.0f, 104.0f, 368.0f)
                lineTo(152.0f, 368.0f)
                curveTo(165.3f, 368.0f, 176.0f, 357.3f, 176.0f, 344.0f)
                lineTo(176.0f, 296.0f)
                curveTo(176.0f, 282.7f, 165.3f, 272.0f, 152.0f, 272.0f)
                lineTo(104.0f, 272.0f)
                curveTo(90.7f, 272.0f, 80.0f, 282.7f, 80.0f, 296.0f)
                close()
                moveTo(104.0f, 432.0f)
                curveTo(90.7f, 432.0f, 80.0f, 442.7f, 80.0f, 456.0f)
                lineTo(80.0f, 504.0f)
                curveTo(80.0f, 517.3f, 90.7f, 528.0f, 104.0f, 528.0f)
                lineTo(152.0f, 528.0f)
                curveTo(165.3f, 528.0f, 176.0f, 517.3f, 176.0f, 504.0f)
                lineTo(176.0f, 456.0f)
                curveTo(176.0f, 442.7f, 165.3f, 432.0f, 152.0f, 432.0f)
                lineTo(104.0f, 432.0f)
                close()
            }
        }
        .build()
...
private var `_list-squares`: ImageVector? = null
