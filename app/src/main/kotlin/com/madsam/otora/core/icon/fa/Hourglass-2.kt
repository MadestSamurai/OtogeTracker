...
public val Fa.`Hourglass-2`: ImageVector
    get() {
        if (`_hourglass-2` != null) {
            return `_hourglass-2`!!
        }
        `_hourglass-2` = Builder(name = "Hourglass-2", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_hourglass-2`: ImageVector? = null
