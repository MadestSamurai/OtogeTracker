...
public val Fa.`File-circle-minus`: ImageVector
    get() {
        if (`_file-circle-minus` != null) {
            return `_file-circle-minus`!!
        }
        `_file-circle-minus` = Builder(name = "File-circle-minus", defaultWidth = 640.0.dp,
...
private var `_file-circle-minus`: ImageVector? = null
