...
public val Fa.`Person-digging`: ImageVector
    get() {
        if (`_person-digging` != null) {
            return `_person-digging`!!
        }
        `_person-digging` = Builder(name = "Person-digging", defaultWidth = 640.0.dp, defaultHeight
...
private var `_person-digging`: ImageVector? = null
