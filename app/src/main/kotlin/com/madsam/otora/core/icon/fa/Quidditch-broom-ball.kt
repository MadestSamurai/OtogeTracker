...
public val Fa.`Quidditch-broom-ball`: ImageVector
    get() {
        if (`_quidditch-broom-ball` != null) {
            return `_quidditch-broom-ball`!!
        }
        `_quidditch-broom-ball` = Builder(name = "Quidditch-broom-ball", defaultWidth = 640.0.dp,
...
private var `_quidditch-broom-ball`: ImageVector? = null
