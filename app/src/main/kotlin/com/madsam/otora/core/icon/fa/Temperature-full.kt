...
public val Fa.`Temperature-full`: ImageVector
    get() {
        if (`_temperature-full` != null) {
            return `_temperature-full`!!
        }
        `_temperature-full` = Builder(name = "Temperature-full", defaultWidth = 640.0.dp,
...
private var `_temperature-full`: ImageVector? = null
