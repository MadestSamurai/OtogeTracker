...
public val Fa.`Arrow-rotate-forward`: ImageVector
    get() {
        if (`_arrow-rotate-forward` != null) {
            return `_arrow-rotate-forward`!!
        }
        `_arrow-rotate-forward` = Builder(name = "Arrow-rotate-forward", defaultWidth = 640.0.dp,
...
private var `_arrow-rotate-forward`: ImageVector? = null
