...
public val Fa.`Angle-double-right`: ImageVector
    get() {
        if (`_angle-double-right` != null) {
            return `_angle-double-right`!!
        }
        `_angle-double-right` = Builder(name = "Angle-double-right", defaultWidth = 640.0.dp,
...
private var `_angle-double-right`: ImageVector? = null
