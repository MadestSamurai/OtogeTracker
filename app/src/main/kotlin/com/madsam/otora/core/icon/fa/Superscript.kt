...
public val Fa.Superscript: ImageVector
    get() {
        if (_superscript != null) {
            return _superscript!!
        }
        _superscript = Builder(name = "Superscript", defaultWidth = 640.0.dp, defaultHeight =
                640.0.dp, viewportWidth = 640.0f, viewportHeight = 640.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(576.0f, 96.0f)
                curveTo(576.0f, 84.9f, 570.3f, 74.6f, 560.8f, 68.8f)
                curveTo(551.3f, 63.0f, 539.6f, 62.4f, 529.7f, 67.4f)
                lineTo(497.7f, 83.4f)
                curveTo(481.9f, 91.3f, 475.5f, 110.5f, 483.4f, 126.3f)
                curveTo(489.0f, 137.5f, 500.3f, 144.0f, 512.0f, 144.0f)
                ...
                curveTo(593.7f, 288.0f, 608.0f, 273.7f, 608.0f, 256.0f)
                curveTo(608.0f, 238.3f, 593.7f, 224.0f, 576.0f, 224.0f)
                lineTo(576.0f, 96.0f)
                close()
