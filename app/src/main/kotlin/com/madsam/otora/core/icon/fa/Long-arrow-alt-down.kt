...
public val Fa.`Long-arrow-alt-down`: ImageVector
    get() {
        if (`_long-arrow-alt-down` != null) {
            return `_long-arrow-alt-down`!!
        }
        `_long-arrow-alt-down` = Builder(name = "Long-arrow-alt-down", defaultWidth = 640.0.dp,
...
private var `_long-arrow-alt-down`: ImageVector? = null
