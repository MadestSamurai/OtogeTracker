...
public val Fa.`Chess-board`: ImageVector
    get() {
        if (`_chess-board` != null) {
            return `_chess-board`!!
        }
        `_chess-board` = Builder(name = "Chess-board", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_chess-board`: ImageVector? = null
