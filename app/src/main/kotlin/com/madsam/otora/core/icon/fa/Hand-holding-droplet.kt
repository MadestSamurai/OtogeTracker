...
public val Fa.`Hand-holding-droplet`: ImageVector
    get() {
        if (`_hand-holding-droplet` != null) {
            return `_hand-holding-droplet`!!
        }
        `_hand-holding-droplet` = Builder(name = "Hand-holding-droplet", defaultWidth = 640.0.dp,
...
private var `_hand-holding-droplet`: ImageVector? = null
