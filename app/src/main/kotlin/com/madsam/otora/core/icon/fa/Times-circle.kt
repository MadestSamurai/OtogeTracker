...
public val Fa.`Times-circle`: ImageVector
    get() {
        if (`_times-circle` != null) {
            return `_times-circle`!!
        }
        `_times-circle` = Builder(name = "Times-circle", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_times-circle`: ImageVector? = null
