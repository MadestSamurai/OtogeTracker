...
public val Fa.`Thermometer-quarter`: ImageVector
    get() {
        if (`_thermometer-quarter` != null) {
            return `_thermometer-quarter`!!
        }
        `_thermometer-quarter` = Builder(name = "Thermometer-quarter", defaultWidth = 640.0.dp,
...
private var `_thermometer-quarter`: ImageVector? = null
