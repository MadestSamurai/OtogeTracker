...
public val Fa.`Hospital-symbol`: ImageVector
    get() {
        if (`_hospital-symbol` != null) {
            return `_hospital-symbol`!!
        }
        `_hospital-symbol` = Builder(name = "Hospital-symbol", defaultWidth = 640.0.dp,
...
private var `_hospital-symbol`: ImageVector? = null
