...
public val Fa.`Person-dots-from-line`: ImageVector
    get() {
        if (`_person-dots-from-line` != null) {
            return `_person-dots-from-line`!!
        }
        `_person-dots-from-line` = Builder(name = "Person-dots-from-line", defaultWidth = 640.0.dp,
...
private var `_person-dots-from-line`: ImageVector? = null
