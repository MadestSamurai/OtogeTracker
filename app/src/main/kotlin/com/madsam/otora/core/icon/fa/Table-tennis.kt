...
public val Fa.`Table-tennis`: ImageVector
    get() {
        if (`_table-tennis` != null) {
            return `_table-tennis`!!
        }
        `_table-tennis` = Builder(name = "Table-tennis", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_table-tennis`: ImageVector? = null
