...
public val Fa.`Laugh-squint`: ImageVector
    get() {
        if (`_laugh-squint` != null) {
            return `_laugh-squint`!!
        }
        `_laugh-squint` = Builder(name = "Laugh-squint", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_laugh-squint`: ImageVector? = null
