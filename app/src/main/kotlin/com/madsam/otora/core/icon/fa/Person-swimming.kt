...
public val Fa.`Person-swimming`: ImageVector
    get() {
        if (`_person-swimming` != null) {
            return `_person-swimming`!!
        }
        `_person-swimming` = Builder(name = "Person-swimming", defaultWidth = 640.0.dp,
...
private var `_person-swimming`: ImageVector? = null
