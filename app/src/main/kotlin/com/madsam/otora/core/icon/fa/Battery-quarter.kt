...
public val Fa.`Battery-quarter`: ImageVector
    get() {
        if (`_battery-quarter` != null) {
            return `_battery-quarter`!!
        }
        `_battery-quarter` = Builder(name = "Battery-quarter", defaultWidth = 640.0.dp,
...
private var `_battery-quarter`: ImageVector? = null
