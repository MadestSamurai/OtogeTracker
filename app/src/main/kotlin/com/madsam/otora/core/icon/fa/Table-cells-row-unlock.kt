...
public val Fa.`Table-cells-row-unlock`: ImageVector
    get() {
        if (`_table-cells-row-unlock` != null) {
            return `_table-cells-row-unlock`!!
        }
        `_table-cells-row-unlock` = Builder(name = "Table-cells-row-unlock", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(559.9f, 318.4f, 545.6f, 304.1f, 528.0f, 304.1f)
                curveTo(510.3f, 304.1f, 496.0f, 318.4f, 496.0f, 336.1f)
                lineTo(496.0f, 384.0f)
                lineTo(592.0f, 384.0f)
                curveTo(618.5f, 384.0f, 640.0f, 405.5f, 640.0f, 432.0f)
                ...
                curveTo(572.2f, 256.1f, 607.9f, 291.9f, 608.0f, 336.0f)
                lineTo(560.0f, 336.0f)
                close()
            }
        }
        .build()
...
private var `_table-cells-row-unlock`: ImageVector? = null
