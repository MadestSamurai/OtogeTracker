...
public val Fa.Crop: ImageVector
    get() {
        if (_crop != null) {
            return _crop!!
        }
        _crop = Builder(name = "Crop", defaultWidth = 640.0.dp, defaultHeight = 640.0.dp,
                viewportWidth = 640.0f, viewportHeight = 640.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(512.0f, 173.3f)
                lineTo(566.6f, 118.7f)
                curveTo(579.1f, 106.2f, 579.1f, 85.9f, 566.6f, 73.4f)
                curveTo(554.1f, 60.9f, 533.8f, 60.9f, 521.3f, 73.4f)
                lineTo(466.7f, 128.0f)
                lineTo(240.0f, 128.0f)
                lineTo(240.0f, 192.0f)
                lineTo(402.7f, 192.0f)
