...
public val Fa.`Radiation-alt`: ImageVector
    get() {
        if (`_radiation-alt` != null) {
            return `_radiation-alt`!!
        }
        `_radiation-alt` = Builder(name = "Radiation-alt", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_radiation-alt`: ImageVector? = null
