...
public val Fa.`Phone-square`: ImageVector
    get() {
        if (`_phone-square` != null) {
            return `_phone-square`!!
        }
        `_phone-square` = Builder(name = "Phone-square", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_phone-square`: ImageVector? = null
