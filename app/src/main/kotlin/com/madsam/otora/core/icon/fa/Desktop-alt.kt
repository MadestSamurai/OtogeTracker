...
public val Fa.`Desktop-alt`: ImageVector
    get() {
        if (`_desktop-alt` != null) {
            return `_desktop-alt`!!
        }
        `_desktop-alt` = Builder(name = "Desktop-alt", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(142.3f, 384.0f, 128.0f, 369.7f, 128.0f, 352.0f)
...
private var `_desktop-alt`: ImageVector? = null
