...
public val Fa.`Phone-square-alt`: ImageVector
    get() {
        if (`_phone-square-alt` != null) {
            return `_phone-square-alt`!!
        }
        `_phone-square-alt` = Builder(name = "Phone-square-alt", defaultWidth = 640.0.dp,
...
private var `_phone-square-alt`: ImageVector? = null
