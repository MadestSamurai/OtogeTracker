...
public val Fa.`Store-alt-slash`: ImageVector
    get() {
        if (`_store-alt-slash` != null) {
            return `_store-alt-slash`!!
        }
        `_store-alt-slash` = Builder(name = "Store-alt-slash", defaultWidth = 640.0.dp,
...
private var `_store-alt-slash`: ImageVector? = null
