...
public val Fa.`Sterling-sign`: ImageVector
    get() {
        if (`_sterling-sign` != null) {
            return `_sterling-sign`!!
        }
        `_sterling-sign` = Builder(name = "Sterling-sign", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_sterling-sign`: ImageVector? = null
