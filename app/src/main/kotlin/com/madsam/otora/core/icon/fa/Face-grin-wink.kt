...
public val Fa.`Face-grin-wink`: ImageVector
    get() {
        if (`_face-grin-wink` != null) {
            return `_face-grin-wink`!!
        }
        `_face-grin-wink` = Builder(name = "Face-grin-wink", defaultWidth = 640.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(392.0f, 260.0f)
                curveTo(381.0f, 260.0f, 372.0f, 269.0f, 372.0f, 280.0f)
                curveTo(372.0f, 291.0f, 363.0f, 300.0f, 352.0f, 300.0f)
                curveTo(341.0f, 300.0f, 332.0f, 291.0f, 332.0f, 280.0f)
                curveTo(332.0f, 246.9f, 358.9f, 220.0f, 392.0f, 220.0f)
                lineTo(408.0f, 220.0f)
                curveTo(441.1f, 220.0f, 468.0f, 246.9f, 468.0f, 280.0f)
                curveTo(468.0f, 291.0f, 459.0f, 300.0f, 448.0f, 300.0f)
                curveTo(437.0f, 300.0f, 428.0f, 291.0f, 428.0f, 280.0f)
                curveTo(428.0f, 269.0f, 419.0f, 260.0f, 408.0f, 260.0f)
                lineTo(392.0f, 260.0f)
                close()
...
private var `_face-grin-wink`: ImageVector? = null
