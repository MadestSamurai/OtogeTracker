...
public val Fa.`Mars-stroke-v`: ImageVector
    get() {
        if (`_mars-stroke-v` != null) {
            return `_mars-stroke-v`!!
        }
        `_mars-stroke-v` = Builder(name = "Mars-stroke-v", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_mars-stroke-v`: ImageVector? = null
