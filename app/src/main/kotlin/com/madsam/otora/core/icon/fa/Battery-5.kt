...
public val Fa.`Battery-5`: ImageVector
    get() {
        if (`_battery-5` != null) {
            return `_battery-5`!!
        }
        `_battery-5` = Builder(name = "Battery-5", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(472.0f, 400.0f)
                curveTo(485.3f, 400.0f, 496.0f, 389.3f, 496.0f, 376.0f)
                lineTo(496.0f, 264.0f)
                curveTo(496.0f, 250.7f, 485.3f, 240.0f, 472.0f, 240.0f)
...
private var `_battery-5`: ImageVector? = null
