...
public val Fa.`Calendar-plus`: ImageVector
    get() {
        if (`_calendar-plus` != null) {
            return `_calendar-plus`!!
        }
        `_calendar-plus` = Builder(name = "Calendar-plus", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(306.7f, 256.0f, 296.0f, 266.7f, 296.0f, 280.0f)
                lineTo(296.0f, 328.0f)
                ...
                lineTo(296.0f, 424.0f)
                curveTo(296.0f, 437.3f, 306.7f, 448.0f, 320.0f, 448.0f)
                curveTo(333.3f, 448.0f, 344.0f, 437.3f, 344.0f, 424.0f)
                lineTo(344.0f, 376.0f)
                ...
                lineTo(344.0f, 280.0f)
                curveTo(344.0f, 266.7f, 333.3f, 256.0f, 320.0f, 256.0f)
                close()
            }
        }
        .build()
