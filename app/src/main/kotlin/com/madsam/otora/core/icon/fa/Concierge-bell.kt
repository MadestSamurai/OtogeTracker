...
public val Fa.`Concierge-bell`: ImageVector
    get() {
        if (`_concierge-bell` != null) {
            return `_concierge-bell`!!
        }
        `_concierge-bell` = Builder(name = "Concierge-bell", defaultWidth = 640.0.dp, defaultHeight
...
private var `_concierge-bell`: ImageVector? = null
