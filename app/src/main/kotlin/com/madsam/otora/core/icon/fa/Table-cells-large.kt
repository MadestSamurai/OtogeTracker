...
public val Fa.`Table-cells-large`: ImageVector
    get() {
        if (`_table-cells-large` != null) {
            return `_table-cells-large`!!
        }
        `_table-cells-large` = Builder(name = "Table-cells-large", defaultWidth = 640.0.dp,
...
private var `_table-cells-large`: ImageVector? = null
