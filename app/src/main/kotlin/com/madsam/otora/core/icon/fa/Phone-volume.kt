...
public val Fa.`Phone-volume`: ImageVector
    get() {
        if (`_phone-volume` != null) {
            return `_phone-volume`!!
        }
        `_phone-volume` = Builder(name = "Phone-volume", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_phone-volume`: ImageVector? = null
