...
public val Fa.`Hryvnia-sign`: ImageVector
    get() {
        if (`_hryvnia-sign` != null) {
            return `_hryvnia-sign`!!
        }
        `_hryvnia-sign` = Builder(name = "Hryvnia-sign", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_hryvnia-sign`: ImageVector? = null
