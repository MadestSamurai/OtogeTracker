...
public val Fa.`Temperature-half`: ImageVector
    get() {
        if (`_temperature-half` != null) {
            return `_temperature-half`!!
        }
        `_temperature-half` = Builder(name = "Temperature-half", defaultWidth = 640.0.dp,
...
private var `_temperature-half`: ImageVector? = null
