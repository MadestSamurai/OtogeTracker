...
public val Fa.`Thermometer-half`: ImageVector
    get() {
        if (`_thermometer-half` != null) {
            return `_thermometer-half`!!
        }
        `_thermometer-half` = Builder(name = "Thermometer-half", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(296.0f, 266.7f, 306.7f, 256.0f, 320.0f, 256.0f)
                curveTo(333.3f, 256.0f, 344.0f, 266.7f, 344.0f, 280.0f)
...
private var `_thermometer-half`: ImageVector? = null
