...
public val Fa.`Square-caret-down`: ImageVector
    get() {
        if (`_square-caret-down` != null) {
            return `_square-caret-down`!!
        }
        `_square-caret-down` = Builder(name = "Square-caret-down", defaultWidth = 640.0.dp,
...
private var `_square-caret-down`: ImageVector? = null
