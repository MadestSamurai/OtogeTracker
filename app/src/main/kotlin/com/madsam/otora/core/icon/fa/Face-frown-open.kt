...
public val Fa.`Face-frown-open`: ImageVector
    get() {
        if (`_face-frown-open` != null) {
            return `_face-frown-open`!!
        }
        `_face-frown-open` = Builder(name = "Face-frown-open", defaultWidth = 640.0.dp,
...
private var `_face-frown-open`: ImageVector? = null
