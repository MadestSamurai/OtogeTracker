...
public val Fa.`Face-laugh-wink`: ImageVector
    get() {
        if (`_face-laugh-wink` != null) {
            return `_face-laugh-wink`!!
        }
        `_face-laugh-wink` = Builder(name = "Face-laugh-wink", defaultWidth = 640.0.dp,
...
private var `_face-laugh-wink`: ImageVector? = null
