...
public val Fa.`Angle-double-left`: ImageVector
    get() {
        if (`_angle-double-left` != null) {
            return `_angle-double-left`!!
        }
        `_angle-double-left` = Builder(name = "Angle-double-left", defaultWidth = 640.0.dp,
...
private var `_angle-double-left`: ImageVector? = null
