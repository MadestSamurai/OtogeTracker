...
public val Fa.`Turkish-lira-sign`: ImageVector
    get() {
        if (`_turkish-lira-sign` != null) {
            return `_turkish-lira-sign`!!
        }
        `_turkish-lira-sign` = Builder(name = "Turkish-lira-sign", defaultWidth = 640.0.dp,
...
private var `_turkish-lira-sign`: ImageVector? = null
