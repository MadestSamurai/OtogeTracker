...
public val Fa.`Share-alt-square`: ImageVector
    get() {
        if (`_share-alt-square` != null) {
            return `_share-alt-square`!!
        }
        `_share-alt-square` = Builder(name = "Share-alt-square", defaultWidth = 640.0.dp,
...
private var `_share-alt-square`: ImageVector? = null
