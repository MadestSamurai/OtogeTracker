...
public val Fa.`Tachometer-average`: ImageVector
    get() {
        if (`_tachometer-average` != null) {
            return `_tachometer-average`!!
        }
        `_tachometer-average` = Builder(name = "Tachometer-average", defaultWidth = 640.0.dp,
...
private var `_tachometer-average`: ImageVector? = null
