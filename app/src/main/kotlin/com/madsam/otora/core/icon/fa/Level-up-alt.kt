...
public val Fa.`Level-up-alt`: ImageVector
    get() {
        if (`_level-up-alt` != null) {
            return `_level-up-alt`!!
        }
        `_level-up-alt` = Builder(name = "Level-up-alt", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_level-up-alt`: ImageVector? = null
