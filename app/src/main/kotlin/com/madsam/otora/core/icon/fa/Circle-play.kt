...
public val Fa.`Circle-play`: ImageVector
    get() {
        if (`_circle-play` != null) {
            return `_circle-play`!!
        }
        `_circle-play` = Builder(name = "Circle-play", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_circle-play`: ImageVector? = null
