...
public val Fa.`Window-close`: ImageVector
    get() {
        if (`_window-close` != null) {
            return `_window-close`!!
        }
        `_window-close` = Builder(name = "Window-close", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_window-close`: ImageVector? = null
