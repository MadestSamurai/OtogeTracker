...
public val Fa.`Vector-polygon`: ImageVector
    get() {
        if (`_vector-polygon` != null) {
            return `_vector-polygon`!!
        }
        `_vector-polygon` = Builder(name = "Vector-polygon", defaultWidth = 640.0.dp, defaultHeight
...
private var `_vector-polygon`: ImageVector? = null
