...
public val Fa.`Pen-to-square`: ImageVector
    get() {
        if (`_pen-to-square` != null) {
            return `_pen-to-square`!!
        }
        `_pen-to-square` = Builder(name = "Pen-to-square", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_pen-to-square`: ImageVector? = null
