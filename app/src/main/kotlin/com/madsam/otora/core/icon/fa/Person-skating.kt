...
public val Fa.`Person-skating`: ImageVector
    get() {
        if (`_person-skating` != null) {
            return `_person-skating`!!
        }
        `_person-skating` = Builder(name = "Person-skating", defaultWidth = 640.0.dp, defaultHeight
...
private var `_person-skating`: ImageVector? = null
