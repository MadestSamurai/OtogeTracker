...
public val Fa.`Caret-square-right`: ImageVector
    get() {
        if (`_caret-square-right` != null) {
            return `_caret-square-right`!!
        }
        `_caret-square-right` = Builder(name = "Caret-square-right", defaultWidth = 640.0.dp,
...
private var `_caret-square-right`: ImageVector? = null
