...
public val Fa.`Home-lg-alt`: ImageVector
    get() {
        if (`_home-lg-alt` != null) {
            return `_home-lg-alt`!!
        }
        `_home-lg-alt` = Builder(name = "Home-lg-alt", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_home-lg-alt`: ImageVector? = null
