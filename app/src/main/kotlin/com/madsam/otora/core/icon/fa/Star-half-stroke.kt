...
public val Fa.`Star-half-stroke`: ImageVector
    get() {
        if (`_star-half-stroke` != null) {
            return `_star-half-stroke`!!
        }
        `_star-half-stroke` = Builder(name = "Star-half-stroke", defaultWidth = 640.0.dp,
...
private var `_star-half-stroke`: ImageVector? = null
