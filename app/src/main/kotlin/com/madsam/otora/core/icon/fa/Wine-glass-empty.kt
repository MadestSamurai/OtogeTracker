...
public val Fa.`Wine-glass-empty`: ImageVector
    get() {
        if (`_wine-glass-empty` != null) {
            return `_wine-glass-empty`!!
        }
        `_wine-glass-empty` = Builder(name = "Wine-glass-empty", defaultWidth = 640.0.dp,
...
private var `_wine-glass-empty`: ImageVector? = null
