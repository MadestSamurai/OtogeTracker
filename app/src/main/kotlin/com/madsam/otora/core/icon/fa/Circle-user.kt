...
public val Fa.`Circle-user`: ImageVector
    get() {
        if (`_circle-user` != null) {
            return `_circle-user`!!
        }
        `_circle-user` = Builder(name = "Circle-user", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_circle-user`: ImageVector? = null
