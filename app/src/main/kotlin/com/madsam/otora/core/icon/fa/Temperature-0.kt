...
public val Fa.`Temperature-0`: ImageVector
    get() {
        if (`_temperature-0` != null) {
            return `_temperature-0`!!
        }
        `_temperature-0` = Builder(name = "Temperature-0", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_temperature-0`: ImageVector? = null
