...
public val Fa.`Backward-step`: ImageVector
    get() {
        if (`_backward-step` != null) {
            return `_backward-step`!!
        }
        `_backward-step` = Builder(name = "Backward-step", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_backward-step`: ImageVector? = null
