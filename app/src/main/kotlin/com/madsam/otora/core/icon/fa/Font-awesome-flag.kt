...
public val Fa.`Font-awesome-flag`: ImageVector
    get() {
        if (`_font-awesome-flag` != null) {
            return `_font-awesome-flag`!!
        }
        `_font-awesome-flag` = Builder(name = "Font-awesome-flag", defaultWidth = 640.0.dp,
...
private var `_font-awesome-flag`: ImageVector? = null
