...
public val Fa.`Search-plus`: ImageVector
    get() {
        if (`_search-plus` != null) {
            return `_search-plus`!!
        }
        `_search-plus` = Builder(name = "Search-plus", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(258.7f, 176.0f, 248.0f, 186.7f, 248.0f, 200.0f)
                lineTo(248.0f, 248.0f)
                ...
                curveTo(296.0f, 186.7f, 285.3f, 176.0f, 272.0f, 176.0f)
                close()
            }
        }
        .build()
...
private var `_search-plus`: ImageVector? = null
