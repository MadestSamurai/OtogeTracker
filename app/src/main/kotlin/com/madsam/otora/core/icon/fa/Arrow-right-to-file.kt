...
public val Fa.`Arrow-right-to-file`: ImageVector
    get() {
        if (`_arrow-right-to-file` != null) {
            return `_arrow-right-to-file`!!
        }
        `_arrow-right-to-file` = Builder(name = "Arrow-right-to-file", defaultWidth = 640.0.dp,
...
private var `_arrow-right-to-file`: ImageVector? = null
