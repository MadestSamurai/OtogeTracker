...
public val Fa.`Sheqel-sign`: ImageVector
    get() {
        if (`_sheqel-sign` != null) {
            return `_sheqel-sign`!!
        }
        `_sheqel-sign` = Builder(name = "Sheqel-sign", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_sheqel-sign`: ImageVector? = null
