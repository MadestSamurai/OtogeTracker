...
public val Fa.`Handshake-alt-slash`: ImageVector
    get() {
        if (`_handshake-alt-slash` != null) {
            return `_handshake-alt-slash`!!
        }
        `_handshake-alt-slash` = Builder(name = "Handshake-alt-slash", defaultWidth = 640.0.dp,
...
private var `_handshake-alt-slash`: ImageVector? = null
