...
public val Fa.`House-chimney-medical`: ImageVector
    get() {
        if (`_house-chimney-medical` != null) {
            return `_house-chimney-medical`!!
        }
        `_house-chimney-medical` = Builder(name = "House-chimney-medical", defaultWidth = 640.0.dp,
...
private var `_house-chimney-medical`: ImageVector? = null
