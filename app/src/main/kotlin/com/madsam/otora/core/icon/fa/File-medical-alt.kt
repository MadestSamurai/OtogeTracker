...
public val Fa.`File-medical-alt`: ImageVector
    get() {
        if (`_file-medical-alt` != null) {
            return `_file-medical-alt`!!
        }
        `_file-medical-alt` = Builder(name = "File-medical-alt", defaultWidth = 640.0.dp,
...
private var `_file-medical-alt`: ImageVector? = null
