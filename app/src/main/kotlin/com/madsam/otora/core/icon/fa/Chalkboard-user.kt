...
public val Fa.`Chalkboard-user`: ImageVector
    get() {
        if (`_chalkboard-user` != null) {
            return `_chalkboard-user`!!
        }
        `_chalkboard-user` = Builder(name = "Chalkboard-user", defaultWidth = 640.0.dp,
...
private var `_chalkboard-user`: ImageVector? = null
