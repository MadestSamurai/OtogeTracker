...
public val Fa.`Down-left-and-up-right-to-center`: ImageVector
    get() {
        if (`_down-left-and-up-right-to-center` != null) {
            return `_down-left-and-up-right-to-center`!!
        }
        `_down-left-and-up-right-to-center` = Builder(name = "Down-left-and-up-right-to-center",
...
private var `_down-left-and-up-right-to-center`: ImageVector? = null
