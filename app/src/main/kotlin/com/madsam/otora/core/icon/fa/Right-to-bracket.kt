...
public val Fa.`Right-to-bracket`: ImageVector
    get() {
        if (`_right-to-bracket` != null) {
            return `_right-to-bracket`!!
        }
        `_right-to-bracket` = Builder(name = "Right-to-bracket", defaultWidth = 640.0.dp,
...
private var `_right-to-bracket`: ImageVector? = null
