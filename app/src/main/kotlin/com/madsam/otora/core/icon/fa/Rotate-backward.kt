...
public val Fa.`Rotate-backward`: ImageVector
    get() {
        if (`_rotate-backward` != null) {
            return `_rotate-backward`!!
        }
        `_rotate-backward` = Builder(name = "Rotate-backward", defaultWidth = 640.0.dp,
...
private var `_rotate-backward`: ImageVector? = null
