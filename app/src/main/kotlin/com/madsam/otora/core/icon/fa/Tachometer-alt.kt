...
public val Fa.`Tachometer-alt`: ImageVector
    get() {
        if (`_tachometer-alt` != null) {
            return `_tachometer-alt`!!
        }
        `_tachometer-alt` = Builder(name = "Tachometer-alt", defaultWidth = 640.0.dp, defaultHeight
...
private var `_tachometer-alt`: ImageVector? = null
