...
public val Fa.`Microphone-alt`: ImageVector
    get() {
        if (`_microphone-alt` != null) {
            return `_microphone-alt`!!
        }
        `_microphone-alt` = Builder(name = "Microphone-alt", defaultWidth = 640.0.dp, defaultHeight
...
private var `_microphone-alt`: ImageVector? = null
