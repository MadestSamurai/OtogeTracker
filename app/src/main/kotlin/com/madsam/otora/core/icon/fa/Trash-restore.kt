...
public val Fa.`Trash-restore`: ImageVector
    get() {
        if (`_trash-restore` != null) {
            return `_trash-restore`!!
        }
        `_trash-restore` = Builder(name = "Trash-restore", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_trash-restore`: ImageVector? = null
