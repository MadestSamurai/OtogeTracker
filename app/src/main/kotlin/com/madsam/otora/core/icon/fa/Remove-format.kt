...
public val Fa.`Remove-format`: ImageVector
    get() {
        if (`_remove-format` != null) {
            return `_remove-format`!!
        }
        `_remove-format` = Builder(name = "Remove-format", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_remove-format`: ImageVector? = null
