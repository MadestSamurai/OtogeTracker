...
public val Fa.`Heart-circle-minus`: ImageVector
    get() {
        if (`_heart-circle-minus` != null) {
            return `_heart-circle-minus`!!
        }
        `_heart-circle-minus` = Builder(name = "Heart-circle-minus", defaultWidth = 640.0.dp,
...
private var `_heart-circle-minus`: ImageVector? = null
