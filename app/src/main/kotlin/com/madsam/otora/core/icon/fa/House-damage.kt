...
public val Fa.`House-damage`: ImageVector
    get() {
        if (`_house-damage` != null) {
            return `_house-damage`!!
        }
        `_house-damage` = Builder(name = "House-damage", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_house-damage`: ImageVector? = null
