...
public val Fa.`Square-arrow-up-right`: ImageVector
    get() {
        if (`_square-arrow-up-right` != null) {
            return `_square-arrow-up-right`!!
        }
        `_square-arrow-up-right` = Builder(name = "Square-arrow-up-right", defaultWidth = 640.0.dp,
...
private var `_square-arrow-up-right`: ImageVector? = null
