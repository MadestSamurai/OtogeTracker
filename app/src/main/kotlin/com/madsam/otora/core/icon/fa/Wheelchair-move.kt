...
public val Fa.`Wheelchair-move`: ImageVector
    get() {
        if (`_wheelchair-move` != null) {
            return `_wheelchair-move`!!
        }
        `_wheelchair-move` = Builder(name = "Wheelchair-move", defaultWidth = 640.0.dp,
...
private var `_wheelchair-move`: ImageVector? = null
