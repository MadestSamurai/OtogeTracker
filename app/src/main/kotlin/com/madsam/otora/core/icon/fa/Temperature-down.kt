...
public val Fa.`Temperature-down`: ImageVector
    get() {
        if (`_temperature-down` != null) {
            return `_temperature-down`!!
        }
        `_temperature-down` = Builder(name = "Temperature-down", defaultWidth = 640.0.dp,
...
private var `_temperature-down`: ImageVector? = null
