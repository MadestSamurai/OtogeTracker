...
public val Fa.`Magnifying-glass-location`: ImageVector
    get() {
        if (`_magnifying-glass-location` != null) {
            return `_magnifying-glass-location`!!
        }
        `_magnifying-glass-location` = Builder(name = "Magnifying-glass-location", defaultWidth =
...
private var `_magnifying-glass-location`: ImageVector? = null
