...
public val Fa.`Circle-exclamation`: ImageVector
    get() {
        if (`_circle-exclamation` != null) {
            return `_circle-exclamation`!!
        }
        `_circle-exclamation` = Builder(name = "Circle-exclamation", defaultWidth = 640.0.dp,
...
private var `_circle-exclamation`: ImageVector? = null
