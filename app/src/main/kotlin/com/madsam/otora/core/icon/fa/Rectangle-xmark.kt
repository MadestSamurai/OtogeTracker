...
public val Fa.`Rectangle-xmark`: ImageVector
    get() {
        if (`_rectangle-xmark` != null) {
            return `_rectangle-xmark`!!
        }
        `_rectangle-xmark` = Builder(name = "Rectangle-xmark", defaultWidth = 640.0.dp,
...
private var `_rectangle-xmark`: ImageVector? = null
