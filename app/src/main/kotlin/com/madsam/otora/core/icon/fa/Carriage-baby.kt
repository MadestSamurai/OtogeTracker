...
public val Fa.`Carriage-baby`: ImageVector
    get() {
        if (`_carriage-baby` != null) {
            return `_carriage-baby`!!
        }
        `_carriage-baby` = Builder(name = "Carriage-baby", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_carriage-baby`: ImageVector? = null
