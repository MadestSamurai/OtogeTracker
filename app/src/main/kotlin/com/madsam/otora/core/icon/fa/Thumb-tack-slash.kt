...
public val Fa.`Thumb-tack-slash`: ImageVector
    get() {
        if (`_thumb-tack-slash` != null) {
            return `_thumb-tack-slash`!!
        }
        `_thumb-tack-slash` = Builder(name = "Thumb-tack-slash", defaultWidth = 640.0.dp,
...
private var `_thumb-tack-slash`: ImageVector? = null
