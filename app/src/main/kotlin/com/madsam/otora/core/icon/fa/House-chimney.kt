...
public val Fa.`House-chimney`: ImageVector
    get() {
        if (`_house-chimney` != null) {
            return `_house-chimney`!!
        }
        `_house-chimney` = Builder(name = "House-chimney", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_house-chimney`: ImageVector? = null
