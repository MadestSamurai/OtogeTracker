...
public val Fa.`Pencil-square`: ImageVector
    get() {
        if (`_pencil-square` != null) {
            return `_pencil-square`!!
        }
        `_pencil-square` = Builder(name = "Pencil-square", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_pencil-square`: ImageVector? = null
