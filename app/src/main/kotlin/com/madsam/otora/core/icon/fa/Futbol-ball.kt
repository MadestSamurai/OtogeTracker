...
public val Fa.`Futbol-ball`: ImageVector
    get() {
        if (`_futbol-ball` != null) {
            return `_futbol-ball`!!
        }
        `_futbol-ball` = Builder(name = "Futbol-ball", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_futbol-ball`: ImageVector? = null
