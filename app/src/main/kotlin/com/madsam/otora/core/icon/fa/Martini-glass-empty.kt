...
public val Fa.`Martini-glass-empty`: ImageVector
    get() {
        if (`_martini-glass-empty` != null) {
            return `_martini-glass-empty`!!
        }
        `_martini-glass-empty` = Builder(name = "Martini-glass-empty", defaultWidth = 640.0.dp,
...
private var `_martini-glass-empty`: ImageVector? = null
