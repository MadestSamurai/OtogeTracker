...
public val Fa.`Rotate-back`: ImageVector
    get() {
        if (`_rotate-back` != null) {
            return `_rotate-back`!!
        }
        `_rotate-back` = Builder(name = "Rotate-back", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_rotate-back`: ImageVector? = null
