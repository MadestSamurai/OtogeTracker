...
public val Fa.`Rectangle-times`: ImageVector
    get() {
        if (`_rectangle-times` != null) {
            return `_rectangle-times`!!
        }
        `_rectangle-times` = Builder(name = "Rectangle-times", defaultWidth = 640.0.dp,
...
private var `_rectangle-times`: ImageVector? = null
