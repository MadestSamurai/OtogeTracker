...
public val Fa.`Sort-amount-asc`: ImageVector
    get() {
        if (`_sort-amount-asc` != null) {
            return `_sort-amount-asc`!!
        }
        `_sort-amount-asc` = Builder(name = "Sort-amount-asc", defaultWidth = 640.0.dp,
...
private var `_sort-amount-asc`: ImageVector? = null
