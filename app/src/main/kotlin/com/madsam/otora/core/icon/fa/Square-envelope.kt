...
public val Fa.`Square-envelope`: ImageVector
    get() {
        if (`_square-envelope` != null) {
            return `_square-envelope`!!
        }
        `_square-envelope` = Builder(name = "Square-envelope", defaultWidth = 640.0.dp,
...
private var `_square-envelope`: ImageVector? = null
