...
public val Fa.`Temperature-high`: ImageVector
    get() {
        if (`_temperature-high` != null) {
            return `_temperature-high`!!
        }
        `_temperature-high` = Builder(name = "Temperature-high", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(280.0f, 146.7f, 269.3f, 136.0f, 256.0f, 136.0f)
                curveTo(242.7f, 136.0f, 232.0f, 146.7f, 232.0f, 160.0f)
...
private var `_temperature-high`: ImageVector? = null
