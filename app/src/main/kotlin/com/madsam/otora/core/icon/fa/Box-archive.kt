...
public val Fa.`Box-archive`: ImageVector
    get() {
        if (`_box-archive` != null) {
            return `_box-archive`!!
        }
        `_box-archive` = Builder(name = "Box-archive", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_box-archive`: ImageVector? = null
