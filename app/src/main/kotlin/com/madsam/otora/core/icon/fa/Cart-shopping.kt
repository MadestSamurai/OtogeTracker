...
public val Fa.`Cart-shopping`: ImageVector
    get() {
        if (`_cart-shopping` != null) {
            return `_cart-shopping`!!
        }
        `_cart-shopping` = Builder(name = "Cart-shopping", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_cart-shopping`: ImageVector? = null
