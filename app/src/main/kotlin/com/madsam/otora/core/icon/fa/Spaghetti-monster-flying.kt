...
public val Fa.`Spaghetti-monster-flying`: ImageVector
    get() {
        if (`_spaghetti-monster-flying` != null) {
            return `_spaghetti-monster-flying`!!
        }
        `_spaghetti-monster-flying` = Builder(name = "Spaghetti-monster-flying", defaultWidth =
...
private var `_spaghetti-monster-flying`: ImageVector? = null
