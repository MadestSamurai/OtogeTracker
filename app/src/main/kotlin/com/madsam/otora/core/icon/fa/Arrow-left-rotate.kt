...
public val Fa.`Arrow-left-rotate`: ImageVector
    get() {
        if (`_arrow-left-rotate` != null) {
            return `_arrow-left-rotate`!!
        }
        `_arrow-left-rotate` = Builder(name = "Arrow-left-rotate", defaultWidth = 640.0.dp,
...
private var `_arrow-left-rotate`: ImageVector? = null
