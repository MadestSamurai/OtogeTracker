...
public val Fa.`Align-right`: ImageVector
    get() {
        if (`_align-right` != null) {
            return `_align-right`!!
        }
        `_align-right` = Builder(name = "Align-right", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(256.0f, 366.3f, 270.3f, 352.0f, 288.0f, 352.0f)
