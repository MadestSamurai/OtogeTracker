...
public val Fa.`Weight-scale`: ImageVector
    get() {
        if (`_weight-scale` != null) {
            return `_weight-scale`!!
        }
        `_weight-scale` = Builder(name = "Weight-scale", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_weight-scale`: ImageVector? = null
