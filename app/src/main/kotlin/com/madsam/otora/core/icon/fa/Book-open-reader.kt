...
public val Fa.`Book-open-reader`: ImageVector
    get() {
        if (`_book-open-reader` != null) {
            return `_book-open-reader`!!
        }
        `_book-open-reader` = Builder(name = "Book-open-reader", defaultWidth = 640.0.dp,
...
private var `_book-open-reader`: ImageVector? = null
