...
public val Fa.`Arrow-rotate-right`: ImageVector
    get() {
        if (`_arrow-rotate-right` != null) {
            return `_arrow-rotate-right`!!
        }
        `_arrow-rotate-right` = Builder(name = "Arrow-rotate-right", defaultWidth = 640.0.dp,
...
private var `_arrow-rotate-right`: ImageVector? = null
