...
public val Fa.`Arrow-rotate-backward`: ImageVector
    get() {
        if (`_arrow-rotate-backward` != null) {
            return `_arrow-rotate-backward`!!
        }
        `_arrow-rotate-backward` = Builder(name = "Arrow-rotate-backward", defaultWidth = 640.0.dp,
...
private var `_arrow-rotate-backward`: ImageVector? = null
