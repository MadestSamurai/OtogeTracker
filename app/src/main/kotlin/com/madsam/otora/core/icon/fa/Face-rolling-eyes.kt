...
public val Fa.`Face-rolling-eyes`: ImageVector
    get() {
        if (`_face-rolling-eyes` != null) {
            return `_face-rolling-eyes`!!
        }
        `_face-rolling-eyes` = Builder(name = "Face-rolling-eyes", defaultWidth = 640.0.dp,
...
private var `_face-rolling-eyes`: ImageVector? = null
