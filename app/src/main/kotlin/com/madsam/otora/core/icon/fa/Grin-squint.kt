...
public val Fa.`Grin-squint`: ImageVector
    get() {
        if (`_grin-squint` != null) {
            return `_grin-squint`!!
        }
        `_grin-squint` = Builder(name = "Grin-squint", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_grin-squint`: ImageVector? = null
