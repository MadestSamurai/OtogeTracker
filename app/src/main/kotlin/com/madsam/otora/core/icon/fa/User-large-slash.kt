...
public val Fa.`User-large-slash`: ImageVector
    get() {
        if (`_user-large-slash` != null) {
            return `_user-large-slash`!!
        }
        `_user-large-slash` = Builder(name = "User-large-slash", defaultWidth = 640.0.dp,
...
private var `_user-large-slash`: ImageVector? = null
