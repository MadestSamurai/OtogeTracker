...
public val Fa.`Headphones-simple`: ImageVector
    get() {
        if (`_headphones-simple` != null) {
            return `_headphones-simple`!!
        }
        `_headphones-simple` = Builder(name = "Headphones-simple", defaultWidth = 640.0.dp,
...
private var `_headphones-simple`: ImageVector? = null
