...
public val Fa.`Whiskey-glass`: ImageVector
    get() {
        if (`_whiskey-glass` != null) {
            return `_whiskey-glass`!!
        }
        `_whiskey-glass` = Builder(name = "Whiskey-glass", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_whiskey-glass`: ImageVector? = null
