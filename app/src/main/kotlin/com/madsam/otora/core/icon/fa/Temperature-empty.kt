...
public val Fa.`Temperature-empty`: ImageVector
    get() {
        if (`_temperature-empty` != null) {
            return `_temperature-empty`!!
        }
        `_temperature-empty` = Builder(name = "Temperature-empty", defaultWidth = 640.0.dp,
...
private var `_temperature-empty`: ImageVector? = null
