...
public val Fa.`Shield-halved`: ImageVector
    get() {
        if (`_shield-halved` != null) {
            return `_shield-halved`!!
        }
        `_shield-halved` = Builder(name = "Shield-halved", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(320.0f, 130.8f)
                lineTo(320.0f, 508.9f)
                curveTo(458.0f, 442.1f, 495.1f, 294.1f, 496.0f, 205.5f)
                lineTo(320.0f, 130.9f)
                lineTo(320.0f, 130.9f)
                close()
            }
        }
...
private var `_shield-halved`: ImageVector? = null
