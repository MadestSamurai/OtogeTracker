...
public val Fa.`Caret-square-left`: ImageVector
    get() {
        if (`_caret-square-left` != null) {
            return `_caret-square-left`!!
        }
        `_caret-square-left` = Builder(name = "Caret-square-left", defaultWidth = 640.0.dp,
...
private var `_caret-square-left`: ImageVector? = null
