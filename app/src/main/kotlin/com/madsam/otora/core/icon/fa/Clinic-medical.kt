...
public val Fa.`Clinic-medical`: ImageVector
    get() {
        if (`_clinic-medical` != null) {
            return `_clinic-medical`!!
        }
        `_clinic-medical` = Builder(name = "Clinic-medical", defaultWidth = 640.0.dp, defaultHeight
...
private var `_clinic-medical`: ImageVector? = null
