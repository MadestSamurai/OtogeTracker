...
public val Fa.`Thermometer-0`: ImageVector
    get() {
        if (`_thermometer-0` != null) {
            return `_thermometer-0`!!
        }
        `_thermometer-0` = Builder(name = "Thermometer-0", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_thermometer-0`: ImageVector? = null
