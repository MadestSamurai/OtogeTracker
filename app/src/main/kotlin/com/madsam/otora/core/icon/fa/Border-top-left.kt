...
public val Fa.`Border-top-left`: ImageVector
    get() {
        if (`_border-top-left` != null) {
            return `_border-top-left`!!
        }
        `_border-top-left` = Builder(name = "Border-top-left", defaultWidth = 640.0.dp,
...
private var `_border-top-left`: ImageVector? = null
