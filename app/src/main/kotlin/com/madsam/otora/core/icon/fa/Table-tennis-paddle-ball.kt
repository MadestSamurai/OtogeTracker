...
public val Fa.`Table-tennis-paddle-ball`: ImageVector
    get() {
        if (`_table-tennis-paddle-ball` != null) {
            return `_table-tennis-paddle-ball`!!
        }
        `_table-tennis-paddle-ball` = Builder(name = "Table-tennis-paddle-ball", defaultWidth =
...
private var `_table-tennis-paddle-ball`: ImageVector? = null
