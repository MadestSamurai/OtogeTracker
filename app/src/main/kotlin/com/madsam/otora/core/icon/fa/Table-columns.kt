...
public val Fa.`Table-columns`: ImageVector
    get() {
        if (`_table-columns` != null) {
            return `_table-columns`!!
        }
        `_table-columns` = Builder(name = "Table-columns", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_table-columns`: ImageVector? = null
