...
public val Fa.`Building-columns`: ImageVector
    get() {
        if (`_building-columns` != null) {
            return `_building-columns`!!
        }
        `_building-columns` = Builder(name = "Building-columns", defaultWidth = 640.0.dp,
...
private var `_building-columns`: ImageVector? = null
