...
public val Fa.`Dice-five`: ImageVector
    get() {
        if (`_dice-five` != null) {
            return `_dice-five`!!
        }
        `_dice-five` = Builder(name = "Dice-five", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(206.3f, 256.0f, 192.0f, 241.7f, 192.0f, 224.0f)
                ...
                curveTo(448.0f, 241.7f, 433.7f, 256.0f, 416.0f, 256.0f)
                curveTo(398.3f, 256.0f, 384.0f, 241.7f, 384.0f, 224.0f)
                close()
                moveTo(416.0f, 384.0f)
                curveTo(433.7f, 384.0f, 448.0f, 398.3f, 448.0f, 416.0f)
                curveTo(448.0f, 433.7f, 433.7f, 448.0f, 416.0f, 448.0f)
                curveTo(398.3f, 448.0f, 384.0f, 433.7f, 384.0f, 416.0f)
                curveTo(384.0f, 398.3f, 398.3f, 384.0f, 416.0f, 384.0f)
                close()
            }
        }
        .build()
