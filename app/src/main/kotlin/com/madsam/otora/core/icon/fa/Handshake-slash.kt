...
public val Fa.`Handshake-slash`: ImageVector
    get() {
        if (`_handshake-slash` != null) {
            return `_handshake-slash`!!
        }
        `_handshake-slash` = Builder(name = "Handshake-slash", defaultWidth = 640.0.dp,
...
private var `_handshake-slash`: ImageVector? = null
