...
public val Fa.`Boxes-stacked`: ImageVector
    get() {
        if (`_boxes-stacked` != null) {
            return `_boxes-stacked`!!
        }
        `_boxes-stacked` = Builder(name = "Boxes-stacked", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_boxes-stacked`: ImageVector? = null
