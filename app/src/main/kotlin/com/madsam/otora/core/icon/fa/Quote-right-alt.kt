...
public val Fa.`Quote-right-alt`: ImageVector
    get() {
        if (`_quote-right-alt` != null) {
            return `_quote-right-alt`!!
        }
        `_quote-right-alt` = Builder(name = "Quote-right-alt", defaultWidth = 640.0.dp,
...
private var `_quote-right-alt`: ImageVector? = null
