...
public val Fa.`Computer-mouse`: ImageVector
    get() {
        if (`_computer-mouse` != null) {
            return `_computer-mouse`!!
        }
        `_computer-mouse` = Builder(name = "Computer-mouse", defaultWidth = 640.0.dp, defaultHeight
...
private var `_computer-mouse`: ImageVector? = null
