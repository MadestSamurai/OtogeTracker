...
public val Fa.`Temperature-up`: ImageVector
    get() {
        if (`_temperature-up` != null) {
            return `_temperature-up`!!
        }
        `_temperature-up` = Builder(name = "Temperature-up", defaultWidth = 640.0.dp, defaultHeight
...
private var `_temperature-up`: ImageVector? = null
