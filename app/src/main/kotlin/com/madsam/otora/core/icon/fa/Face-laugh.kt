...
public val Fa.`Face-laugh`: ImageVector
    get() {
        if (`_face-laugh` != null) {
            return `_face-laugh`!!
        }
        `_face-laugh` = Builder(name = "Face-laugh", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(417.7f, 224.0f, 432.0f, 238.3f, 432.0f, 256.0f)
                curveTo(432.0f, 273.7f, 417.7f, 288.0f, 400.0f, 288.0f)
                curveTo(382.3f, 288.0f, 368.0f, 273.7f, 368.0f, 256.0f)
                curveTo(368.0f, 238.3f, 382.3f, 224.0f, 400.0f, 224.0f)
                close()
            }
        }
        .build()
...
private var `_face-laugh`: ImageVector? = null
