...
public val Fa.`Arrow-alt-circle-down`: ImageVector
    get() {
        if (`_arrow-alt-circle-down` != null) {
            return `_arrow-alt-circle-down`!!
        }
        `_arrow-alt-circle-down` = Builder(name = "Arrow-alt-circle-down", defaultWidth = 640.0.dp,
...
private var `_arrow-alt-circle-down`: ImageVector? = null
