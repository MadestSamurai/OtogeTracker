...
public val Fa.`Battery-half`: ImageVector
    get() {
        if (`_battery-half` != null) {
            return `_battery-half`!!
        }
        `_battery-half` = Builder(name = "Battery-half", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(325.3f, 400.0f, 336.0f, 389.3f, 336.0f, 376.0f)
                lineTo(336.0f, 264.0f)
                curveTo(336.0f, 250.7f, 325.3f, 240.0f, 312.0f, 240.0f)
...
private var `_battery-half`: ImageVector? = null
