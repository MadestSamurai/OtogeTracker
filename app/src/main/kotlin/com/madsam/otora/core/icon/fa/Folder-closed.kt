...
public val Fa.`Folder-closed`: ImageVector
    get() {
        if (`_folder-closed` != null) {
            return `_folder-closed`!!
        }
        `_folder-closed` = Builder(name = "Folder-closed", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_folder-closed`: ImageVector? = null
