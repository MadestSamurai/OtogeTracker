...
public val Fa.`Arrow-up-long`: ImageVector
    get() {
        if (`_arrow-up-long` != null) {
            return `_arrow-up-long`!!
        }
        `_arrow-up-long` = Builder(name = "Arrow-up-long", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_arrow-up-long`: ImageVector? = null
