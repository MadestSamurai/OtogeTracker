...
public val Fa.`Long-arrow-right`: ImageVector
    get() {
        if (`_long-arrow-right` != null) {
            return `_long-arrow-right`!!
        }
        `_long-arrow-right` = Builder(name = "Long-arrow-right", defaultWidth = 640.0.dp,
...
private var `_long-arrow-right`: ImageVector? = null
