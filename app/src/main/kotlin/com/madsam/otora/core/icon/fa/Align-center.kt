...
public val Fa.`Align-center`: ImageVector
    get() {
        if (`_align-center` != null) {
            return `_align-center`!!
        }
        `_align-center` = Builder(name = "Align-center", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(433.7f, 160.0f, 448.0f, 145.7f, 448.0f, 128.0f)
                close()
                ...
                curveTo(448.0f, 366.3f, 433.7f, 352.0f, 416.0f, 352.0f)
                lineTo(224.0f, 352.0f)
                curveTo(206.3f, 352.0f, 192.0f, 366.3f, 192.0f, 384.0f)
                curveTo(192.0f, 401.7f, 206.3f, 416.0f, 224.0f, 416.0f)
