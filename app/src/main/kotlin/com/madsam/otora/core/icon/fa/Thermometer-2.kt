...
public val Fa.`Thermometer-2`: ImageVector
    get() {
        if (`_thermometer-2` != null) {
            return `_thermometer-2`!!
        }
        `_thermometer-2` = Builder(name = "Thermometer-2", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_thermometer-2`: ImageVector? = null
