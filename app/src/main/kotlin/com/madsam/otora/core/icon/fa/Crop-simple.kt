...
public val Fa.`Crop-simple`: ImageVector
    get() {
        if (`_crop-simple` != null) {
            return `_crop-simple`!!
        }
        `_crop-simple` = Builder(name = "Crop-simple", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_crop-simple`: ImageVector? = null
