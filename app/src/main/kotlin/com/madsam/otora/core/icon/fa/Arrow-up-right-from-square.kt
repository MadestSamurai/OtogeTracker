...
public val Fa.`Arrow-up-right-from-square`: ImageVector
    get() {
        if (`_arrow-up-right-from-square` != null) {
            return `_arrow-up-right-from-square`!!
        }
        `_arrow-up-right-from-square` = Builder(name = "Arrow-up-right-from-square", defaultWidth =
...
private var `_arrow-up-right-from-square`: ImageVector? = null
