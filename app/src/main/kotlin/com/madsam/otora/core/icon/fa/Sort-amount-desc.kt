...
public val Fa.`Sort-amount-desc`: ImageVector
    get() {
        if (`_sort-amount-desc` != null) {
            return `_sort-amount-desc`!!
        }
        `_sort-amount-desc` = Builder(name = "Sort-amount-desc", defaultWidth = 640.0.dp,
...
private var `_sort-amount-desc`: ImageVector? = null
