...
public val Fa.`Step-forward`: ImageVector
    get() {
        if (`_step-forward` != null) {
            return `_step-forward`!!
        }
        `_step-forward` = Builder(name = "Step-forward", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_step-forward`: ImageVector? = null
