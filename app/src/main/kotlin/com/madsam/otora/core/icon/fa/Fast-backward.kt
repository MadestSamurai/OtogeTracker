...
public val Fa.`Fast-backward`: ImageVector
    get() {
        if (`_fast-backward` != null) {
            return `_fast-backward`!!
        }
        `_fast-backward` = Builder(name = "Fast-backward", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_fast-backward`: ImageVector? = null
