...
public val Fa.`Toilet-paper-blank`: ImageVector
    get() {
        if (`_toilet-paper-blank` != null) {
            return `_toilet-paper-blank`!!
        }
        `_toilet-paper-blank` = Builder(name = "Toilet-paper-blank", defaultWidth = 640.0.dp,
...
private var `_toilet-paper-blank`: ImageVector? = null
