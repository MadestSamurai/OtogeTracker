...
public val Fa.`Square-caret-up`: ImageVector
    get() {
        if (`_square-caret-up` != null) {
            return `_square-caret-up`!!
        }
        `_square-caret-up` = Builder(name = "Square-caret-up", defaultWidth = 640.0.dp,
...
private var `_square-caret-up`: ImageVector? = null
