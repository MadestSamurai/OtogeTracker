...
public val Fa.`Face-surprise`: ImageVector
    get() {
        if (`_face-surprise` != null) {
            return `_face-surprise`!!
        }
        `_face-surprise` = Builder(name = "Face-surprise", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_face-surprise`: ImageVector? = null
