...
public val Fa.`Unlock-keyhole`: ImageVector
    get() {
        if (`_unlock-keyhole` != null) {
            return `_unlock-keyhole`!!
        }
        `_unlock-keyhole` = Builder(name = "Unlock-keyhole", defaultWidth = 640.0.dp, defaultHeight
...
private var `_unlock-keyhole`: ImageVector? = null
