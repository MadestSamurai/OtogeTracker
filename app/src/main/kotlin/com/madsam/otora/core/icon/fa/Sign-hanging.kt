...
public val Fa.`Sign-hanging`: ImageVector
    get() {
        if (`_sign-hanging` != null) {
            return `_sign-hanging`!!
        }
        `_sign-hanging` = Builder(name = "Sign-hanging", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_sign-hanging`: ImageVector? = null
