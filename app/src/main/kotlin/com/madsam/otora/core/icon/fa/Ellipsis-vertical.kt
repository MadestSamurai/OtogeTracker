...
public val Fa.`Ellipsis-vertical`: ImageVector
    get() {
        if (`_ellipsis-vertical` != null) {
            return `_ellipsis-vertical`!!
        }
        `_ellipsis-vertical` = Builder(name = "Ellipsis-vertical", defaultWidth = 640.0.dp,
...
private var `_ellipsis-vertical`: ImageVector? = null
