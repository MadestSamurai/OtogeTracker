...
public val Fa.`Square-up-right`: ImageVector
    get() {
        if (`_square-up-right` != null) {
            return `_square-up-right`!!
        }
        `_square-up-right` = Builder(name = "Square-up-right", defaultWidth = 640.0.dp,
...
private var `_square-up-right`: ImageVector? = null
