...
public val Fa.`Volume-xmark`: ImageVector
    get() {
        if (`_volume-xmark` != null) {
            return `_volume-xmark`!!
        }
        `_volume-xmark` = Builder(name = "Volume-xmark", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_volume-xmark`: ImageVector? = null
