...
public val Fa.`Trash-can-arrow-up`: ImageVector
    get() {
        if (`_trash-can-arrow-up` != null) {
            return `_trash-can-arrow-up`!!
        }
        `_trash-can-arrow-up` = Builder(name = "Trash-can-arrow-up", defaultWidth = 640.0.dp,
...
private var `_trash-can-arrow-up`: ImageVector? = null
