...
public val Fa.`Circle-half-stroke`: ImageVector
    get() {
        if (`_circle-half-stroke` != null) {
            return `_circle-half-stroke`!!
        }
        `_circle-half-stroke` = Builder(name = "Circle-half-stroke", defaultWidth = 640.0.dp,
...
private var `_circle-half-stroke`: ImageVector? = null
