...
public val Fa.`Hourglass-end`: ImageVector
    get() {
        if (`_hourglass-end` != null) {
            return `_hourglass-end`!!
        }
        `_hourglass-end` = Builder(name = "Hourglass-end", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_hourglass-end`: ImageVector? = null
