...
public val Fa.`Compress-arrows-alt`: ImageVector
    get() {
        if (`_compress-arrows-alt` != null) {
            return `_compress-arrows-alt`!!
        }
        `_compress-arrows-alt` = Builder(name = "Compress-arrows-alt", defaultWidth = 640.0.dp,
...
private var `_compress-arrows-alt`: ImageVector? = null
