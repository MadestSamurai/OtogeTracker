...
public val Fa.`Person-biking`: ImageVector
    get() {
        if (`_person-biking` != null) {
            return `_person-biking`!!
        }
        `_person-biking` = Builder(name = "Person-biking", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_person-biking`: ImageVector? = null
