...
public val Fa.`Truck-ramp-box`: ImageVector
    get() {
        if (`_truck-ramp-box` != null) {
            return `_truck-ramp-box`!!
        }
        `_truck-ramp-box` = Builder(name = "Truck-ramp-box", defaultWidth = 640.0.dp, defaultHeight
...
private var `_truck-ramp-box`: ImageVector? = null
