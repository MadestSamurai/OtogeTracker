...
public val Fa.`Map-marked-alt`: ImageVector
    get() {
        if (`_map-marked-alt` != null) {
            return `_map-marked-alt`!!
        }
        `_map-marked-alt` = Builder(name = "Map-marked-alt", defaultWidth = 640.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(445.7f, 288.0f, 392.0f, 340.8f, 392.0f, 405.9f)
                ...
                close()
                moveTo(472.0f, 408.0f)
                curveTo(472.0f, 385.9f, 489.9f, 368.0f, 512.0f, 368.0f)
                curveTo(534.1f, 368.0f, 552.0f, 385.9f, 552.0f, 408.0f)
                curveTo(552.0f, 430.1f, 534.1f, 448.0f, 512.0f, 448.0f)
                curveTo(489.9f, 448.0f, 472.0f, 430.1f, 472.0f, 408.0f)
                close()
            }
        }
        .build()
...
private var `_map-marked-alt`: ImageVector? = null
