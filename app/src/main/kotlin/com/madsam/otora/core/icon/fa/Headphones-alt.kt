...
public val Fa.`Headphones-alt`: ImageVector
    get() {
        if (`_headphones-alt` != null) {
            return `_headphones-alt`!!
        }
        `_headphones-alt` = Builder(name = "Headphones-alt", defaultWidth = 640.0.dp, defaultHeight
...
private var `_headphones-alt`: ImageVector? = null
