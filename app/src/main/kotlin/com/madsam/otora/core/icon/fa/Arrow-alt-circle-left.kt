...
public val Fa.`Arrow-alt-circle-left`: ImageVector
    get() {
        if (`_arrow-alt-circle-left` != null) {
            return `_arrow-alt-circle-left`!!
        }
        `_arrow-alt-circle-left` = Builder(name = "Arrow-alt-circle-left", defaultWidth = 640.0.dp,
...
private var `_arrow-alt-circle-left`: ImageVector? = null
