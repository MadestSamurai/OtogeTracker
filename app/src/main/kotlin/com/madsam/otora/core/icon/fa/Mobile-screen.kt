...
public val Fa.`Mobile-screen`: ImageVector
    get() {
        if (`_mobile-screen` != null) {
            return `_mobile-screen`!!
        }
        `_mobile-screen` = Builder(name = "Mobile-screen", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_mobile-screen`: ImageVector? = null
