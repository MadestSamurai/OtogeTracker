...
public val Fa.`Gauge-simple`: ImageVector
    get() {
        if (`_gauge-simple` != null) {
            return `_gauge-simple`!!
        }
        `_gauge-simple` = Builder(name = "Gauge-simple", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_gauge-simple`: ImageVector? = null
