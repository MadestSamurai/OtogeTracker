...
public val Fa.`Thermometer-full`: ImageVector
    get() {
        if (`_thermometer-full` != null) {
            return `_thermometer-full`!!
        }
        `_thermometer-full` = Builder(name = "Thermometer-full", defaultWidth = 640.0.dp,
...
private var `_thermometer-full`: ImageVector? = null
