...
public val Fa.`Shield-blank`: ImageVector
    get() {
        if (`_shield-blank` != null) {
            return `_shield-blank`!!
        }
        `_shield-blank` = Builder(name = "Shield-blank", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_shield-blank`: ImageVector? = null
