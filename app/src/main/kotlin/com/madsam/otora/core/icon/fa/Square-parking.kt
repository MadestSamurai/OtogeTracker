...
public val Fa.`Square-parking`: ImageVector
    get() {
        if (`_square-parking` != null) {
            return `_square-parking`!!
        }
        `_square-parking` = Builder(name = "Square-parking", defaultWidth = 640.0.dp, defaultHeight
...
private var `_square-parking`: ImageVector? = null
