...
public val Fa.`Long-arrow-left`: ImageVector
    get() {
        if (`_long-arrow-left` != null) {
            return `_long-arrow-left`!!
        }
        `_long-arrow-left` = Builder(name = "Long-arrow-left", defaultWidth = 640.0.dp,
...
private var `_long-arrow-left`: ImageVector? = null
