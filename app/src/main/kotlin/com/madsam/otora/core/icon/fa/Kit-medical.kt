...
public val Fa.`Kit-medical`: ImageVector
    get() {
        if (`_kit-medical` != null) {
            return `_kit-medical`!!
        }
        `_kit-medical` = Builder(name = "Kit-medical", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_kit-medical`: ImageVector? = null
