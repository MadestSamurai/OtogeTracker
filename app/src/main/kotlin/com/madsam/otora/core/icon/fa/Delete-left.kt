...
public val Fa.`Delete-left`: ImageVector
    get() {
        if (`_delete-left` != null) {
            return `_delete-left`!!
        }
        `_delete-left` = Builder(name = "Delete-left", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_delete-left`: ImageVector? = null
