...
public val Fa.`Mortar-board`: ImageVector
    get() {
        if (`_mortar-board` != null) {
            return `_mortar-board`!!
        }
        `_mortar-board` = Builder(name = "Mortar-board", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_mortar-board`: ImageVector? = null
