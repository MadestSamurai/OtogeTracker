...
public val Fa.`Indian-rupee-sign`: ImageVector
    get() {
        if (`_indian-rupee-sign` != null) {
            return `_indian-rupee-sign`!!
        }
        `_indian-rupee-sign` = Builder(name = "Indian-rupee-sign", defaultWidth = 640.0.dp,
...
private var `_indian-rupee-sign`: ImageVector? = null
