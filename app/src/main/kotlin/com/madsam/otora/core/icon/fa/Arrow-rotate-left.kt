...
public val Fa.`Arrow-rotate-left`: ImageVector
    get() {
        if (`_arrow-rotate-left` != null) {
            return `_arrow-rotate-left`!!
        }
        `_arrow-rotate-left` = Builder(name = "Arrow-rotate-left", defaultWidth = 640.0.dp,
...
private var `_arrow-rotate-left`: ImageVector? = null
