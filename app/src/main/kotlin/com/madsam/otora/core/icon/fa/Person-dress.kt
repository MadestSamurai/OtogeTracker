...
public val Fa.`Person-dress`: ImageVector
    get() {
        if (`_person-dress` != null) {
            return `_person-dress`!!
        }
        `_person-dress` = Builder(name = "Person-dress", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_person-dress`: ImageVector? = null
