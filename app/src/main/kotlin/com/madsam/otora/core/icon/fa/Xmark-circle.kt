...
public val Fa.`Xmark-circle`: ImageVector
    get() {
        if (`_xmark-circle` != null) {
            return `_xmark-circle`!!
        }
        `_xmark-circle` = Builder(name = "Xmark-circle", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_xmark-circle`: ImageVector? = null
