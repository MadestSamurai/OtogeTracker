...
public val Fa.`Circle-xmark`: ImageVector
    get() {
        if (`_circle-xmark` != null) {
            return `_circle-xmark`!!
        }
        `_circle-xmark` = Builder(name = "Circle-xmark", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_circle-xmark`: ImageVector? = null
