...
public val Fa.`Id-card-clip`: ImageVector
    get() {
        if (`_id-card-clip` != null) {
            return `_id-card-clip`!!
        }
        `_id-card-clip` = Builder(name = "Id-card-clip", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_id-card-clip`: ImageVector? = null
