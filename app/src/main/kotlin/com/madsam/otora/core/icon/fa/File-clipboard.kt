...
public val Fa.`File-clipboard`: ImageVector
    get() {
        if (`_file-clipboard` != null) {
            return `_file-clipboard`!!
        }
        `_file-clipboard` = Builder(name = "File-clipboard", defaultWidth = 640.0.dp, defaultHeight
...
private var `_file-clipboard`: ImageVector? = null
