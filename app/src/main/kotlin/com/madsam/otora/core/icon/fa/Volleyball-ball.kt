...
public val Fa.`Volleyball-ball`: ImageVector
    get() {
        if (`_volleyball-ball` != null) {
            return `_volleyball-ball`!!
        }
        `_volleyball-ball` = Builder(name = "Volleyball-ball", defaultWidth = 640.0.dp,
...
private var `_volleyball-ball`: ImageVector? = null
