...
public val Fa.`Thermometer-1`: ImageVector
    get() {
        if (`_thermometer-1` != null) {
            return `_thermometer-1`!!
        }
        `_thermometer-1` = Builder(name = "Thermometer-1", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_thermometer-1`: ImageVector? = null
