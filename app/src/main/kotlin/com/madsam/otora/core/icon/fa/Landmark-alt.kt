...
public val Fa.`Landmark-alt`: ImageVector
    get() {
        if (`_landmark-alt` != null) {
            return `_landmark-alt`!!
        }
        `_landmark-alt` = Builder(name = "Landmark-alt", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_landmark-alt`: ImageVector? = null
