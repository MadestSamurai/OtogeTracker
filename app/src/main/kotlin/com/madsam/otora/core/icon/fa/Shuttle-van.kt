...
public val Fa.`Shuttle-van`: ImageVector
    get() {
        if (`_shuttle-van` != null) {
            return `_shuttle-van`!!
        }
        `_shuttle-van` = Builder(name = "Shuttle-van", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_shuttle-van`: ImageVector? = null
