...
public val Fa.`Project-diagram`: ImageVector
    get() {
        if (`_project-diagram` != null) {
            return `_project-diagram`!!
        }
        `_project-diagram` = Builder(name = "Project-diagram", defaultWidth = 640.0.dp,
...
private var `_project-diagram`: ImageVector? = null
