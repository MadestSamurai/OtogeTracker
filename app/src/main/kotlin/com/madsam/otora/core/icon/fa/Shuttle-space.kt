...
public val Fa.`Shuttle-space`: ImageVector
    get() {
        if (`_shuttle-space` != null) {
            return `_shuttle-space`!!
        }
        `_shuttle-space` = Builder(name = "Shuttle-space", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_shuttle-space`: ImageVector? = null
