...
public val Fa.`Map-location-dot`: ImageVector
    get() {
        if (`_map-location-dot` != null) {
            return `_map-location-dot`!!
        }
        `_map-location-dot` = Builder(name = "Map-location-dot", defaultWidth = 640.0.dp,
...
private var `_map-location-dot`: ImageVector? = null
