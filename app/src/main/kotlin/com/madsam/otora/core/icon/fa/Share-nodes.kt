...
public val Fa.`Share-nodes`: ImageVector
    get() {
        if (`_share-nodes` != null) {
            return `_share-nodes`!!
        }
        `_share-nodes` = Builder(name = "Share-nodes", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_share-nodes`: ImageVector? = null
