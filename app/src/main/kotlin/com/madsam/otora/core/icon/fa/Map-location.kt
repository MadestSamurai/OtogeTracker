...
public val Fa.`Map-location`: ImageVector
    get() {
        if (`_map-location` != null) {
            return `_map-location`!!
        }
        `_map-location` = Builder(name = "Map-location", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_map-location`: ImageVector? = null
