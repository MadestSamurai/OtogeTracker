...
public val Fa.`Temperature-4`: ImageVector
    get() {
        if (`_temperature-4` != null) {
            return `_temperature-4`!!
        }
        `_temperature-4` = Builder(name = "Temperature-4", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_temperature-4`: ImageVector? = null
