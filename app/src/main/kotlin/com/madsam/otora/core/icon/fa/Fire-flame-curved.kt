...
public val Fa.`Fire-flame-curved`: ImageVector
    get() {
        if (`_fire-flame-curved` != null) {
            return `_fire-flame-curved`!!
        }
        `_fire-flame-curved` = Builder(name = "Fire-flame-curved", defaultWidth = 640.0.dp,
...
private var `_fire-flame-curved`: ImageVector? = null
