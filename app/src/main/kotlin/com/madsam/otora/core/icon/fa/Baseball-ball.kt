...
public val Fa.`Baseball-ball`: ImageVector
    get() {
        if (`_baseball-ball` != null) {
            return `_baseball-ball`!!
        }
        `_baseball-ball` = Builder(name = "Baseball-ball", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_baseball-ball`: ImageVector? = null
