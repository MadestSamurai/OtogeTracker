...
public val Fa.`Long-arrow-down`: ImageVector
    get() {
        if (`_long-arrow-down` != null) {
            return `_long-arrow-down`!!
        }
        `_long-arrow-down` = Builder(name = "Long-arrow-down", defaultWidth = 640.0.dp,
...
private var `_long-arrow-down`: ImageVector? = null
