...
public val Fa.`Mars-stroke-right`: ImageVector
    get() {
        if (`_mars-stroke-right` != null) {
            return `_mars-stroke-right`!!
        }
        `_mars-stroke-right` = Builder(name = "Mars-stroke-right", defaultWidth = 640.0.dp,
...
private var `_mars-stroke-right`: ImageVector? = null
