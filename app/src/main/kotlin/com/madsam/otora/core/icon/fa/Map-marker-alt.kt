...
public val Fa.`Map-marker-alt`: ImageVector
    get() {
        if (`_map-marker-alt` != null) {
            return `_map-marker-alt`!!
        }
        `_map-marker-alt` = Builder(name = "Map-marker-alt", defaultWidth = 640.0.dp, defaultHeight
...
private var `_map-marker-alt`: ImageVector? = null
