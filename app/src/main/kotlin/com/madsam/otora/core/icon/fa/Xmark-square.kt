...
public val Fa.`Xmark-square`: ImageVector
    get() {
        if (`_xmark-square` != null) {
            return `_xmark-square`!!
        }
        `_xmark-square` = Builder(name = "Xmark-square", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_xmark-square`: ImageVector? = null
