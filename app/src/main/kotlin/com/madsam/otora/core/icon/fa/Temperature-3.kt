...
public val Fa.`Temperature-3`: ImageVector
    get() {
        if (`_temperature-3` != null) {
            return `_temperature-3`!!
        }
        `_temperature-3` = Builder(name = "Temperature-3", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_temperature-3`: ImageVector? = null
