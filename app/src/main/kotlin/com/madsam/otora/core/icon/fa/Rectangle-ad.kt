...
public val Fa.`Rectangle-ad`: ImageVector
    get() {
        if (`_rectangle-ad` != null) {
            return `_rectangle-ad`!!
        }
        `_rectangle-ad` = Builder(name = "Rectangle-ad", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_rectangle-ad`: ImageVector? = null
