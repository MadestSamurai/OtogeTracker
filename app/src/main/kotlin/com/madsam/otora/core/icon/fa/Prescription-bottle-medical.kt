...
public val Fa.`Prescription-bottle-medical`: ImageVector
    get() {
        if (`_prescription-bottle-medical` != null) {
            return `_prescription-bottle-medical`!!
        }
        `_prescription-bottle-medical` = Builder(name = "Prescription-bottle-medical", defaultWidth
...
private var `_prescription-bottle-medical`: ImageVector? = null
