...
public val Fa.`Drivers-license`: ImageVector
    get() {
        if (`_drivers-license` != null) {
            return `_drivers-license`!!
        }
        `_drivers-license` = Builder(name = "Drivers-license", defaultWidth = 640.0.dp,
...
private var `_drivers-license`: ImageVector? = null
