...
public val Fa.`Hourglass-1`: ImageVector
    get() {
        if (`_hourglass-1` != null) {
            return `_hourglass-1`!!
        }
        `_hourglass-1` = Builder(name = "Hourglass-1", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_hourglass-1`: ImageVector? = null
