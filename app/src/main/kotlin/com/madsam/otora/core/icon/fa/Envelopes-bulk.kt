...
public val Fa.`Envelopes-bulk`: ImageVector
    get() {
        if (`_envelopes-bulk` != null) {
            return `_envelopes-bulk`!!
        }
        `_envelopes-bulk` = Builder(name = "Envelopes-bulk", defaultWidth = 640.0.dp, defaultHeight
...
private var `_envelopes-bulk`: ImageVector? = null
