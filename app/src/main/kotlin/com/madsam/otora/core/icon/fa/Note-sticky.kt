...
public val Fa.`Note-sticky`: ImageVector
    get() {
        if (`_note-sticky` != null) {
            return `_note-sticky`!!
        }
        `_note-sticky` = Builder(name = "Note-sticky", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_note-sticky`: ImageVector? = null
