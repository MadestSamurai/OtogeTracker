...
public val Fa.`Thermometer-4`: ImageVector
    get() {
        if (`_thermometer-4` != null) {
            return `_thermometer-4`!!
        }
        `_thermometer-4` = Builder(name = "Thermometer-4", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_thermometer-4`: ImageVector? = null
