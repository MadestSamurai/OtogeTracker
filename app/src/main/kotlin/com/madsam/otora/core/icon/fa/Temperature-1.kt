...
public val Fa.`Temperature-1`: ImageVector
    get() {
        if (`_temperature-1` != null) {
            return `_temperature-1`!!
        }
        `_temperature-1` = Builder(name = "Temperature-1", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_temperature-1`: ImageVector? = null
