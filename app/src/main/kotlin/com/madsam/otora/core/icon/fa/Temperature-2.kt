...
public val Fa.`Temperature-2`: ImageVector
    get() {
        if (`_temperature-2` != null) {
            return `_temperature-2`!!
        }
        `_temperature-2` = Builder(name = "Temperature-2", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_temperature-2`: ImageVector? = null
