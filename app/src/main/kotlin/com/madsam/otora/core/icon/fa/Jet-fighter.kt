...
public val Fa.`Jet-fighter`: ImageVector
    get() {
        if (`_jet-fighter` != null) {
            return `_jet-fighter`!!
        }
        `_jet-fighter` = Builder(name = "Jet-fighter", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_jet-fighter`: ImageVector? = null
