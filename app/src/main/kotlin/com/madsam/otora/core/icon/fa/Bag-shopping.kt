...
public val Fa.`Bag-shopping`: ImageVector
    get() {
        if (`_bag-shopping` != null) {
            return `_bag-shopping`!!
        }
        `_bag-shopping` = Builder(name = "Bag-shopping", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_bag-shopping`: ImageVector? = null
