...
public val Fa.`Times-rectangle`: ImageVector
    get() {
        if (`_times-rectangle` != null) {
            return `_times-rectangle`!!
        }
        `_times-rectangle` = Builder(name = "Times-rectangle", defaultWidth = 640.0.dp,
...
private var `_times-rectangle`: ImageVector? = null
