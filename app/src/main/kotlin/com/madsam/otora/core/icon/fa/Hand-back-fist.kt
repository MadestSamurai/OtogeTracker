...
public val Fa.`Hand-back-fist`: ImageVector
    get() {
        if (`_hand-back-fist` != null) {
            return `_hand-back-fist`!!
        }
        `_hand-back-fist` = Builder(name = "Hand-back-fist", defaultWidth = 640.0.dp, defaultHeight
...
private var `_hand-back-fist`: ImageVector? = null
