...
public val Fa.`Hand-dots`: ImageVector
    get() {
        if (`_hand-dots` != null) {
            return `_hand-dots`!!
        }
        `_hand-dots` = Builder(name = "Hand-dots", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(352.0f, 96.0f)
                close()
                moveTo(264.0f, 416.0f)
                curveTo(264.0f, 402.7f, 274.7f, 392.0f, 288.0f, 392.0f)
                curveTo(301.3f, 392.0f, 312.0f, 402.7f, 312.0f, 416.0f)
                curveTo(312.0f, 429.3f, 301.3f, 440.0f, 288.0f, 440.0f)
                curveTo(274.7f, 440.0f, 264.0f, 429.3f, 264.0f, 416.0f)
                close()
                moveTo(384.0f, 360.0f)
                curveTo(397.3f, 360.0f, 408.0f, 370.7f, 408.0f, 384.0f)
                curveTo(408.0f, 397.3f, 397.3f, 408.0f, 384.0f, 408.0f)
                curveTo(370.7f, 408.0f, 360.0f, 397.3f, 360.0f, 384.0f)
                curveTo(360.0f, 370.7f, 370.7f, 360.0f, 384.0f, 360.0f)
                close()
                moveTo(424.0f, 448.0f)
                curveTo(424.0f, 434.7f, 434.7f, 424.0f, 448.0f, 424.0f)
                curveTo(461.3f, 424.0f, 472.0f, 434.7f, 472.0f, 448.0f)
                curveTo(472.0f, 461.3f, 461.3f, 472.0f, 448.0f, 472.0f)
                curveTo(434.7f, 472.0f, 424.0f, 461.3f, 424.0f, 448.0f)
                close()
                moveTo(336.0f, 472.0f)
                curveTo(349.3f, 472.0f, 360.0f, 482.7f, 360.0f, 496.0f)
                curveTo(360.0f, 509.3f, 349.3f, 520.0f, 336.0f, 520.0f)
                curveTo(322.7f, 520.0f, 312.0f, 509.3f, 312.0f, 496.0f)
                curveTo(312.0f, 482.7f, 322.7f, 472.0f, 336.0f, 472.0f)
                close()
            }
        }
        .build()
...
private var `_hand-dots`: ImageVector? = null
