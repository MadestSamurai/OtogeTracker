...
public val Fa.`Tachometer-alt-average`: ImageVector
    get() {
        if (`_tachometer-alt-average` != null) {
            return `_tachometer-alt-average`!!
        }
        `_tachometer-alt-average` = Builder(name = "Tachometer-alt-average", defaultWidth =
...
private var `_tachometer-alt-average`: ImageVector? = null
