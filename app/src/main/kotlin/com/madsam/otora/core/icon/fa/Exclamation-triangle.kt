...
public val Fa.`Exclamation-triangle`: ImageVector
    get() {
        if (`_exclamation-triangle` != null) {
            return `_exclamation-triangle`!!
        }
        `_exclamation-triangle` = Builder(name = "Exclamation-triangle", defaultWidth = 640.0.dp,
...
private var `_exclamation-triangle`: ImageVector? = null
