...
public val Fa.`Share-square`: ImageVector
    get() {
        if (`_share-square` != null) {
            return `_share-square`!!
        }
        `_share-square` = Builder(name = "Share-square", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_share-square`: ImageVector? = null
