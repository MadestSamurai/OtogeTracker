...
public val Fa.`Sign-out-alt`: ImageVector
    get() {
        if (`_sign-out-alt` != null) {
            return `_sign-out-alt`!!
        }
        `_sign-out-alt` = Builder(name = "Sign-out-alt", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_sign-out-alt`: ImageVector? = null
