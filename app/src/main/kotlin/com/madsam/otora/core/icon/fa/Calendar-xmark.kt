...
public val Fa.`Calendar-xmark`: ImageVector
    get() {
        if (`_calendar-xmark` != null) {
            return `_calendar-xmark`!!
        }
        `_calendar-xmark` = Builder(name = "Calendar-xmark", defaultWidth = 640.0.dp, defaultHeight
...
private var `_calendar-xmark`: ImageVector? = null
