...
public val Fa.`File-half-dashed`: ImageVector
    get() {
        if (`_file-half-dashed` != null) {
            return `_file-half-dashed`!!
        }
        `_file-half-dashed` = Builder(name = "File-half-dashed", defaultWidth = 640.0.dp,
...
private var `_file-half-dashed`: ImageVector? = null
