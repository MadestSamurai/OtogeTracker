...
public val Fa.`Gauge-simple-high`: ImageVector
    get() {
        if (`_gauge-simple-high` != null) {
            return `_gauge-simple-high`!!
        }
        `_gauge-simple-high` = Builder(name = "Gauge-simple-high", defaultWidth = 640.0.dp,
...
private var `_gauge-simple-high`: ImageVector? = null
