...
public val Fa.`Ticket-simple`: ImageVector
    get() {
        if (`_ticket-simple` != null) {
            return `_ticket-simple`!!
        }
        `_ticket-simple` = Builder(name = "Ticket-simple", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_ticket-simple`: ImageVector? = null
