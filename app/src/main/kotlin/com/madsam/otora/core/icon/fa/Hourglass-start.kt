...
public val Fa.`Hourglass-start`: ImageVector
    get() {
        if (`_hourglass-start` != null) {
            return `_hourglass-start`!!
        }
        `_hourglass-start` = Builder(name = "Hourglass-start", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(160.0f, 64.0f)
                close()
                moveTo(416.0f, 501.0f)
                lineTo(416.0f, 512.0f)
                lineTo(224.0f, 512.0f)
                lineTo(224.0f, 501.0f)
                curveTo(224.0f, 475.5f, 234.1f, 451.1f, 252.1f, 433.1f)
                lineTo(320.0f, 365.2f)
                lineTo(387.9f, 433.1f)
                curveTo(405.9f, 451.1f, 416.0f, 475.5f, 416.0f, 501.0f)
                close()
            }
        }
        .build()
...
private var `_hourglass-start`: ImageVector? = null
