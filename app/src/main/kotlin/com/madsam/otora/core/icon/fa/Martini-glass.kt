...
public val Fa.`Martini-glass`: ImageVector
    get() {
        if (`_martini-glass` != null) {
            return `_martini-glass`!!
        }
        `_martini-glass` = Builder(name = "Martini-glass", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_martini-glass`: ImageVector? = null
