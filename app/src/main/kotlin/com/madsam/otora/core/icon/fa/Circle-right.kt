...
public val Fa.`Circle-right`: ImageVector
    get() {
        if (`_circle-right` != null) {
            return `_circle-right`!!
        }
        `_circle-right` = Builder(name = "Circle-right", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_circle-right`: ImageVector? = null
