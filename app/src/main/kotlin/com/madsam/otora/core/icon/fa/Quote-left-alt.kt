...
public val Fa.`Quote-left-alt`: ImageVector
    get() {
        if (`_quote-left-alt` != null) {
            return `_quote-left-alt`!!
        }
        `_quote-left-alt` = Builder(name = "Quote-left-alt", defaultWidth = 640.0.dp, defaultHeight
...
private var `_quote-left-alt`: ImageVector? = null
