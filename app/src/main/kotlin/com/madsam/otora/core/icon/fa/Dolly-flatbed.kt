...
public val Fa.`Dolly-flatbed`: ImageVector
    get() {
        if (`_dolly-flatbed` != null) {
            return `_dolly-flatbed`!!
        }
        `_dolly-flatbed` = Builder(name = "Dolly-flatbed", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_dolly-flatbed`: ImageVector? = null
