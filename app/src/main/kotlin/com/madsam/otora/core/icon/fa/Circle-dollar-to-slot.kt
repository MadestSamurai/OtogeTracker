...
public val Fa.`Circle-dollar-to-slot`: ImageVector
    get() {
        if (`_circle-dollar-to-slot` != null) {
            return `_circle-dollar-to-slot`!!
        }
        `_circle-dollar-to-slot` = Builder(name = "Circle-dollar-to-slot", defaultWidth = 640.0.dp,
...
private var `_circle-dollar-to-slot`: ImageVector? = null
