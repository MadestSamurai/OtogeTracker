...
public val Fa.`Diagram-predecessor`: ImageVector
    get() {
        if (`_diagram-predecessor` != null) {
            return `_diagram-predecessor`!!
        }
        `_diagram-predecessor` = Builder(name = "Diagram-predecessor", defaultWidth = 640.0.dp,
...
private var `_diagram-predecessor`: ImageVector? = null
