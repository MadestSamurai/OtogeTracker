...
public val Fa.`Bars-progress`: ImageVector
    get() {
        if (`_bars-progress` != null) {
            return `_bars-progress`!!
        }
        `_bars-progress` = Builder(name = "Bars-progress", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_bars-progress`: ImageVector? = null
