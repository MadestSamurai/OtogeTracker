...
public val Fa.`Shekel-sign`: ImageVector
    get() {
        if (`_shekel-sign` != null) {
            return `_shekel-sign`!!
        }
        `_shekel-sign` = Builder(name = "Shekel-sign", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_shekel-sign`: ImageVector? = null
