...
public val Fa.`Thermometer-3`: ImageVector
    get() {
        if (`_thermometer-3` != null) {
            return `_thermometer-3`!!
        }
        `_thermometer-3` = Builder(name = "Thermometer-3", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_thermometer-3`: ImageVector? = null
