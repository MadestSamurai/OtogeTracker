...
public val Fa.`Arrow-rotate-back`: ImageVector
    get() {
        if (`_arrow-rotate-back` != null) {
            return `_arrow-rotate-back`!!
        }
        `_arrow-rotate-back` = Builder(name = "Arrow-rotate-back", defaultWidth = 640.0.dp,
...
private var `_arrow-rotate-back`: ImageVector? = null
