...
public val Fa.`Volume-times`: ImageVector
    get() {
        if (`_volume-times` != null) {
            return `_volume-times`!!
        }
        `_volume-times` = Builder(name = "Volume-times", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_volume-times`: ImageVector? = null
