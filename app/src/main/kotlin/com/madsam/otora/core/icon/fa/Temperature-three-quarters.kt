...
public val Fa.`Temperature-three-quarters`: ImageVector
    get() {
        if (`_temperature-three-quarters` != null) {
            return `_temperature-three-quarters`!!
        }
        `_temperature-three-quarters` = Builder(name = "Temperature-three-quarters", defaultWidth =
...
private var `_temperature-three-quarters`: ImageVector? = null
