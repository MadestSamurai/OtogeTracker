...
public val Fa.`Bars-staggered`: ImageVector
    get() {
        if (`_bars-staggered` != null) {
            return `_bars-staggered`!!
        }
        `_bars-staggered` = Builder(name = "Bars-staggered", defaultWidth = 640.0.dp, defaultHeight
...
private var `_bars-staggered`: ImageVector? = null
