...
public val Fa.`Font-awesome`: ImageVector
    get() {
        if (`_font-awesome` != null) {
            return `_font-awesome`!!
        }
        `_font-awesome` = Builder(name = "Font-awesome", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_font-awesome`: ImageVector? = null
