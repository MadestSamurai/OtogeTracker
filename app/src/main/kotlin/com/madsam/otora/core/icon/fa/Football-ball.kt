...
public val Fa.`Football-ball`: ImageVector
    get() {
        if (`_football-ball` != null) {
            return `_football-ball`!!
        }
        `_football-ball` = Builder(name = "Football-ball", defaultWidth = 640.0.dp, defaultHeight =
...
private var `_football-ball`: ImageVector? = null
