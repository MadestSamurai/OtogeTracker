...
public val Fa.`Face-smile-wink`: ImageVector
    get() {
        if (`_face-smile-wink` != null) {
            return `_face-smile-wink`!!
        }
        `_face-smile-wink` = Builder(name = "Face-smile-wink", defaultWidth = 640.0.dp,
...
private var `_face-smile-wink`: ImageVector? = null
