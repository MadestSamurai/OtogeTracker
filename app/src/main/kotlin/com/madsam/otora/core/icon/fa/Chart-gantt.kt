...
public val Fa.`Chart-gantt`: ImageVector
    get() {
        if (`_chart-gantt` != null) {
            return `_chart-gantt`!!
        }
        `_chart-gantt` = Builder(name = "Chart-gantt", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(192.0f, 177.7f, 206.3f, 192.0f, 224.0f, 192.0f)
                ...
                curveTo(270.3f, 240.0f, 256.0f, 254.3f, 256.0f, 272.0f)
                curveTo(256.0f, 289.7f, 270.3f, 304.0f, 288.0f, 304.0f)
                lineTo(416.0f, 304.0f)
                curveTo(433.7f, 304.0f, 448.0f, 289.7f, 448.0f, 272.0f)
                curveTo(448.0f, 254.3f, 433.7f, 240.0f, 416.0f, 240.0f)
                lineTo(288.0f, 240.0f)
                close()
                moveTo(448.0f, 352.0f)
                curveTo(430.3f, 352.0f, 416.0f, 366.3f, 416.0f, 384.0f)
                curveTo(416.0f, 401.7f, 430.3f, 416.0f, 448.0f, 416.0f)
...
private var `_chart-gantt`: ImageVector? = null
